...
export class HabilidadesBlandasComponent {
  ...
  public cards: any = {
    en: [
      { title: 'Creativity', content: 'I am a highly creative person, capable of generating innovative ideas and original solutions to challenges. I have used my creativity in design, marketing, and advertising projects, and I am constantly looking for ways to think outside the box to improve processes and products. Additionally, I have the ability to communicate my ideas clearly and persuasively.' },
      { title: 'Leadership', content: 'As a leader, I have demonstrated my ability to guide teams towards success. I am a compassionate and empathetic leader, who values the perspectives and needs of each team member. I have led teams in large-scale projects, and I have effectively coordinated tasks, resources, and timelines. Additionally, I am committed to the professional development of my team and always seek opportunities to motivate and empower them.' },
      { title: 'Critical Thinking', content: 'I am an analytical and rigorous person, capable of evaluating complex information and situations from multiple perspectives. I have used my critical thinking skills in projects involving data analysis, business strategies, and important decision-making. I always value evidence and logic in my decision-making and seek opportunities to learn and grow in my critical thinking. Additionally, I am able to communicate my analysis clearly and effectively.' }
    ],
    es: [
